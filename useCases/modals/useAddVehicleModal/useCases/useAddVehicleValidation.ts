...
export const useAddVehicleValidation = () => {
  ...
  const localesPath = {
    rent: 'addVehicleModal.forms.rejectMessage.rent',
    name: 'addVehicleModal.forms.rejectMessage.name',
    description: 'addVehicleModal.forms.rejectMessage.description',
    image: 'addVehicleModal.forms.rejectMessage.image',
    type: 'addVehicleModal.forms.rejectMessage.type'
  }
